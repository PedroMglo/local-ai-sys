...
def chunk_treesitter(
    ...
    try:
        ...
        from obsidian_rag.chunking.code import _chunk_text_fallback
        return _chunk_text_fallback(source, rel_path, repo_name, Path(rel_path).name, cfg)
