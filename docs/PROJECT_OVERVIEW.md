...
> **Versão:** 0.5.3
> **Última atualização:** 2026-05-12 (concorrência real com Qdrant server mode, #188)
...
├── tests/                      # Testes automatizados (pytest) — 436 testes (4 skipped)
│   ├── __init__.py
...
| Módulo             | Função                                                                                                                                                                                                                                                                                 |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rag.py`           | `build_rag_context()` — entry point. Usa `VectorStore` protocol via `_get_store()` (thin proxy para `store.get_store()` singleton process-wide). Adaptive top_k (`_estimate_complexity`). Multi-estratégia: vector + keyword + title. Deduplicação, threshold dinâmico, relevance gate |
...
**436 testes** (4 skipped) em 23 ficheiros, sem dependências externas (Ollama):
...
| Limitação                         | Descrição                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Cobertura de testes parcial**   | 436 testes (4 skipped, unit + integration + concorrência) cobrindo chunking (markdown + code + tree-sitter), router, budget, API auth, CLI, segurança, performance, adaptive top_k, vault_sync, cross-platform, manifest, ingest pipeline, ResourceGovernor, VectorStore protocol (incl. health), Dask engine, graphify incremental, concorrência (parallel queries, query during upsert, multi-collection, health under load) e multi-vault. Faltam e2e tests com Ollama |
...
| Aspeto                  | Estado                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Versão**              | 0.5.3 (concorrência real Qdrant server mode, 2026-05-12, #188)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| **Testes**              | 436 testes (4 skipped) em 23 ficheiros com pytest. Todos passam sem deps externas. Cobertura: 61%. Inclui testes de concorrência (`test_concurrency.py`) e `TestHealth` em vector store. CI inclui job `test-server-mode` com Qdrant service container                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
